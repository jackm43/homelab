...
variable "create_example_vault" {
  type        = bool
  default     = false
  description = "Whether to create an example vault"
}

variable "create_example_item" {
  type        = bool
  default     = false
  description = "Whether to create an example item"
}

variable "default_vault_id" {
  type        = string
  default     = ""
  description = "Default vault ID to use for items if not creating an example vault"
}
